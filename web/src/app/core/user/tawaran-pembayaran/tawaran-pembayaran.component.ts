...
@Component({
  selector: "app-tawaran-pembayaran",
  templateUrl: "./tawaran-pembayaran.component.html",
  styleUrls: ["./tawaran-pembayaran.component.scss"],
})
export class TawaranPembayaranComponent implements OnInit, OnDestroy {
  // Chart
  chart: any;
  ...
  getChart2() {
    ...
    let chart = am4core.create("chartPembayaran2", am4charts.PieChart);
  ...
  getChart() {
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartPembayaran", am4charts.XYChart);
