...
@Component({
  selector: "app-tawaran-urusan-baki",
  templateUrl: "./tawaran-urusan-baki.component.html",
  styleUrls: ["./tawaran-urusan-baki.component.scss"],
})
export class TawaranUrusanBakiComponent implements OnInit, OnDestroy {
  // Chart
  chart: any;
  ...
  getChart() {
    ...
    let chart = am4core.create("chartUrusanLain", am4charts.XYChart);
