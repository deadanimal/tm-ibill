...
@Component({
  selector: "app-senarai-pemohon",
  templateUrl: "./senarai-pemohon.component.html",
  styleUrls: ["./senarai-pemohon.component.scss"],
})
export class SenaraiPemohonComponent implements OnInit, OnDestroy {
  // Chart
  chart: any;
