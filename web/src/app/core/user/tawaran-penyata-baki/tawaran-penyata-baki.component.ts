...
@Component({
  selector: "app-tawaran-penyata-baki",
  templateUrl: "./tawaran-penyata-baki.component.html",
  styleUrls: ["./tawaran-penyata-baki.component.scss"],
})
export class TawaranPenyataBakiComponent implements OnInit, OnDestroy {
  // Chart
  chart: any;
  ...
  listTawaranPenyata: any = [
    {
      cust: "001",
      title: "Keterangan 1",
      debit: "RM1000",
      kredit: "",
      description: "Program khas Kakitangan Negeri Selangor",
    ...
    },
    {
      ...
      debit: "",
      kredit: "RM1000",
      description: "Biasiswa Sagong Tasi",
      created_at: "2019-07-27T01:07:14Z",
    },
    {
      cust: "003",
  ...
  getChart() {
    ...
    let chart = am4core.create("chartTawaranPenyata", am4charts.XYChart);
