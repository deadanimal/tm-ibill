...
@Component({
  selector: "app-bill-interactive-personalisation",
  templateUrl: "./bill-interactive-personalisation.component.html",
  styleUrls: ["./bill-interactive-personalisation.component.scss"],
})
export class BillinteractivePersonalisationComponent
  ...
  getChart1() {
    // chart half circle
    let chart = am4core.create("chartdivBillInteractive1", am4charts.PieChart);
  ...
  getChart2() {
    // chart ada gambo org
    let chart = am4core.create("chartdivBillInteractive2", am4charts.XYChart);
  ...
  getChart3() {
    ...
    let chart = am4core.create("chartdivBillInteractive3", am4charts.XYChart);
  ...
  getChart4() {
    ...
    let chart = am4core.create("chartdivBillInteractive4", am4charts.XYChart);
  ...
  getChart5() {
    // chart bar 2 line
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartdivBillInteractive5", am4charts.XYChart);
    chart.colors.step = 2;
  ...
  getChart6() {
    // pie chart
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartdivBillInteractive6", am4charts.PieChart);
