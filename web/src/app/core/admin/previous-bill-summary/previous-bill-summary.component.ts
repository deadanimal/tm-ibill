...
@Component({
  selector: "app-previous-bill-summary",
  templateUrl: "./previous-bill-summary.component.html",
  styleUrls: ["./previous-bill-summary.component.scss"],
})
export class PreviousBillSummaryComponent implements OnInit, OnDestroy {
  // Chart
  chart: any;
