...
@Component({
  selector: "app-bill-diversion",
  templateUrl: "./bill-diversion.component.html",
  styleUrls: ["./bill-diversion.component.scss"],
})
export class BillDiversionComponent implements OnInit, OnDestroy {
  // Chart
  chart: any;
  ...
  getChart() {
    //chart nate susoh
    let container = am4core.create("chartdivBillDiversion", am4core.Container);
  ...
  getChart1() {
    // chart half circle
    let chart = am4core.create("chartdivBillDiversion1", am4charts.PieChart);
  ...
  getChart2() {
    // chart ada gambo org
    let chart = am4core.create("chartdivBillDiversion2", am4charts.XYChart);
