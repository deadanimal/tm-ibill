...
@Component({
  selector: "app-email-template-personalisation",
  templateUrl: "./email-template-personalisation.component.html",
  styleUrls: ["./email-template-personalisation.component.scss"],
})
export class EmailTemplatePersonalisationComponent
  ...
  getChart1() {
    // chart half circle
    let chart = am4core.create("chartdivEmailInteractive1", am4charts.PieChart);
  ...
  getChart2() {
    // chart ada gambo org
    let chart = am4core.create("chartdivEmailInteractive2", am4charts.XYChart);
  ...
  getChart3() {
    ...
    let chart = am4core.create("chartdivEmailInteractive3", am4charts.XYChart);
  ...
  getChart4() {
    ...
    let chart = am4core.create("chartdivEmailInteractive4", am4charts.XYChart);
  ...
  getChart5() {
    // chart bar 2 line
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartdivEmailInteractive5", am4charts.XYChart);
    chart.colors.step = 2;
  ...
  getChart6() {
    // pie chart
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartdivEmailInteractive6", am4charts.PieChart);
