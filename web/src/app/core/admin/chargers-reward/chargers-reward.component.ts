...
@Component({
  selector: "app-chargers-reward",
  templateUrl: "./chargers-reward.component.html",
  styleUrls: ["./chargers-reward.component.scss"],
})
export class ChargersRewardComponent implements OnInit, OnDestroy {
  // Chart
  chart: any;
