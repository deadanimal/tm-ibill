...
@Component({
  selector: "app-chargers-announcement",
  templateUrl: "./chargers-announcement.component.html",
  styleUrls: ["./chargers-announcement.component.scss"],
})
export class ChargersAnnouncementComponent implements OnInit, OnDestroy {
  // Chart
  chart: any;
  ...
  listPenguatkuasa: any = [
    {
      name: "Announcement",
      seg: "All",
      mess: "This is the message for this announcement",
      created_by: "Ali",
      season: "Hari Raya",
    ...
    },
    {
      name: "Advertisement",
      seg: "Consumer",
      mess: "This is the message for this advertisement",
      created_by: "Kamal",
      season: "Deepavali",
      created_at: "2019-07-27T01:07:14Z",
    },
