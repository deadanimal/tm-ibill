...
@Component({
  selector: "app-chargers-bill-summary",
  templateUrl: "./chargers-bill-summary.component.html",
  styleUrls: ["./chargers-bill-summary.component.scss"],
})
export class ChargersBillSummaryComponent implements OnInit, OnDestroy {
  // Chart
  chart: any;
  ...
  getChart() {
    //chart nate susoh
    let container = am4core.create("chartdivBillsummary", am4core.Container);
  ...
  getChart1() {
    // chart half circle
    let chart = am4core.create("chartdivBillsummary1", am4charts.PieChart);
  ...
  getChart2() {
    // chart ada gambo org
    let chart = am4core.create("chartdivBillsummary2", am4charts.XYChart);
  ...
  getChart3() {
    ...
    let chart = am4core.create("chartdivBillsummary3", am4charts.XYChart);
  ...
  getChart4() {
    ...
    let chart = am4core.create("chartdivBillsummary4", am4charts.XYChart);
  ...
  getChart5() {
    // chart bar 2 line
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartdivBillsummary5", am4charts.XYChart);
    chart.colors.step = 2;
  ...
  getChart6() {
    // pie chart
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartdivBillsummary6", am4charts.PieChart);
