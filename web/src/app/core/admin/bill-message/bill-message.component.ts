...
@Component({
  selector: "app-bill-message",
  templateUrl: "./bill-message.component.html",
  styleUrls: ["./bill-message.component.scss"],
})
export class BillMessageComponent implements OnInit, OnDestroy {
  // Chart
  chart: any;
  ...
  getChart() {
    ...
    let chart = am4core.create("chartAmmStockHolding", am4charts.XYChart);
  ...
  getChart2() {
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartAmmStockHolding2", am4charts.PieChart);
