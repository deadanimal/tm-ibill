...
@Component({
  selector: "app-bill-stream-code",
  templateUrl: "./bill-stream-code.component.html",
  styleUrls: ["./bill-stream-code.component.scss"],
})
export class BillStreamCodeComponent implements OnInit, OnDestroy {
  // Chart
  chart: any;
