...
@Component({
  selector: "app-email-bill-return",
  templateUrl: "./email-bill-return.component.html",
  styleUrls: ["./email-bill-return.component.scss"],
})
export class EmailBillReturnComponent implements OnInit, OnDestroy {
  // Chart
  chart: any;
  ...
  navigatePage(path: String) {
    ...
    if (path == "/admin//utility/Actions") {
      ...
      return this.router.navigate(["/admin/permohonan-baru"]);
    }
  }
  ...
  getChart() {
    //chart nate susoh
    let container = am4core.create("chartdivBillReturn", am4core.Container);
  ...
  getChart1() {
    // chart half circle
    let chart = am4core.create("chartdivBillReturn1", am4charts.PieChart);
  ...
  getChart2() {
    // chart ada gambo org
    let chart = am4core.create("chartdivBillReturn2", am4charts.XYChart);
  ...
  getChart3() {
    ...
    let chart = am4core.create("chartdivBillReturn3", am4charts.XYChart);
  ...
  getChart4() {
    ...
    let chart = am4core.create("chartdivBillReturn4", am4charts.XYChart);
  ...
  getChart5() {
    // chart bar 2 line
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartdivBillReturn5", am4charts.XYChart);
    chart.colors.step = 2;
  ...
  getChart6() {
    // pie chart
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartdivBillReturn6", am4charts.PieChart);
