...
@Component({
  selector: "app-bill-statement-interactive",
  templateUrl: "./bill-statement-interactive.component.html",
  styleUrls: ["./bill-statement-interactive.component.scss"],
})
export class BillStatementInteractiveComponent implements OnInit, OnDestroy {
  // Chart
  chart: any;
  ...
  getChart() {
    //chart nate susoh
    let container = am4core.create("chartdivBillstreamcode", am4core.Container);
  ...
  getChart1() {
    // chart half circle
    let chart = am4core.create("chartdivBillstreamcode1", am4charts.PieChart);
  ...
  getChart2() {
    // chart ada gambo org
    let chart = am4core.create("chartdivBillstreamcode2", am4charts.XYChart);
  ...
  getChart3() {
    ...
    let chart = am4core.create("chartdivBillstreamcode3", am4charts.XYChart);
  ...
  getChart4() {
    ...
    let chart = am4core.create("chartdivBillstreamcode4", am4charts.XYChart);
  ...
  getChart5() {
    // chart bar 2 line
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartdivBillstreamcode5", am4charts.XYChart);
    chart.colors.step = 2;
  ...
  getChart6() {
    // pie chart
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartdivBillstreamcode6", am4charts.PieChart);
